...
@Component({
  selector: 'app-creae-application',
  templateUrl: './creae-application.component.html',
  styleUrls: ['./creae-application.component.css']
})
export class CreaeApplicationComponent implements OnInit {
